...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#E2E4CE] min-h-screen flex flex-col text-[#C24984]`}
      >
        {/* BARRA DE NAVEGAÇÃO SUPERIOR (NAVBAR) */}
        <nav className="bg-[#E5CE82] px-8 py-4 flex justify-between items-center border-b-2 border-[#C24984]/20 sticky top-0 z-50 shadow-sm shrink-0">
          {/* Logo Estrela */}
        ...
        {/* CONTEÚDO DA PÁGINA */}
        {/* Correção: O flex-1 distribui o tamanho perfeitamente e elimina de vez a barra de rolagem dupla */}
