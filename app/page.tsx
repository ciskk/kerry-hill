...
export default function Home() {
  ...
  // Monitoriza o scroll do utilizador para ativar as animações de entrada dos Destaques
  useEffect(() => {
    ...
    return () => {
      if (destaquesRef.current) {
        observer.unobserve(destaquesRef.current);
      }
    };
  }, []);

  return (
    <div className="w-full bg-[#E2E4CE] text-[#C24984] overflow-x-hidden min-h-screen pb-12">
      
      {/* Estilos CSS nativos para animações personalizadas de alto desempenho (60 FPS) */}
      <style>{`
        @keyframes slideLeft {
        ...
        .animate-slide-right-bounce {
          animation: slideRightBounce 1s cubic-bezier(0.175, 0.885, 0.32, 1.1) forwards;
        }
        .animate-fade-in-up {
      ...
      <section className="min-h-[90vh] flex flex-col md:flex-row items-center justify-between px-4 md:px-8 py-12 relative max-w-[1300px] mx-auto w-full pt-16 md:pt-24 gap-12 md:gap-4">
        ...
        {/* BLOCO ESQUERDO: Título e Ovelha Sobrepostos com animações de entrada coordenadas */}
        <div className="relative flex w-full md:w-[50%] items-center justify-start mt-8 md:mt-0 min-h-[350px] md:min-h-[450px]">
          
          <div className="absolute z-30 left-0 md:left-4 top-1/2 -translate-y-1/2 flex flex-col pointer-events-none animate-slide-left">
          ...
          <div className="z-10 relative ml-[25%] md:ml-[35%] flex-shrink-0 animate-scale-up">
            <div className="relative border-[1.5px] border-black p-1 bg-transparent hover:rotate-2 transition-transform duration-500">
              {/* Pontos de ancoragem para simulação de corte de imagem */}
        ...
        {/* BLOCO DIREITO: Texto Explicativo e Cher com entrada elástica */}
        <div className="flex flex-row items-end justify-center md:justify-start relative w-full md:w-[50%] mt-12 md:mt-0">
          
          <div className="z-10 bg-[#E2E4CE]/90 p-6 md:p-7 rounded-xl w-[260px] md:w-[320px] shadow-sm relative animate-scale-up" style={{ animationDelay: "200ms" }}>
            <div className="flex items-center gap-2 mb-4">
              <h3 className="text-4xl md:text-5xl font-serif text-[#E5CE82] italic drop-shadow-[1.5px_1.5px_0px_#C24984]">
                Kerry Hills:
              </h3>
              <img src="/assets/star.png" alt="Estrela" className="w-[30px] h-[30px] object-contain animate-[spin_10s_linear_infinite]" />
            </div>
          ...
          <div className="z-20 pointer-events-none -ml-[22px] md:-ml-[38px] -mb-8 md:-mb-16 flex-shrink-0 animate-slide-right-bounce">
            <img
              src="/assets/inicio-cher.png"
              alt="Dionne a piscar o olho"
      ...
      <section 
        ref={destaquesRef}
        className="min-h-screen flex flex-col justify-center px-4 md:px-12 py-20 max-w-[1200px] mx-auto w-full"
      >
        
        <div className={`flex flex-col md:flex-row items-center justify-start gap-8 mb-16 transition-all duration-1000 ease-out transform
          ${destaquesVisivel ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}
        >
          ...
          <div className="z-0 -mt-4 md:-mt-12">
            <img
              ...
              className="object-contain w-[250px] md:w-[350px] h-auto drop-shadow-xl hover:scale-105 hover:rotate-3 transition-all duration-500"
            />
          </div>
        </div>

        {/* Grid de Cards Amarelos com efeito de surgimento em cascata (Staggered Reveal) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          ...
          <div className={`transition-all duration-700 ease-out transform delay-500
            ${destaquesVisivel ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
            <Card title="Guia do Criador">
